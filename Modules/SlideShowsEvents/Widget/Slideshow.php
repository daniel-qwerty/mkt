...
class SlideShowsEvents_Widget_Slideshow extends Com_Object {
   ...
   /**
     ...
     * @static
     * @access public
     * @return SlideShowsEvents_Widget_Slideshow 
     */
    ...
    public function render() {
        ...
        $list = SlideShowsEvents_Model_SlideShow::getInstance()->getListEnable($this->lan->LanId);
