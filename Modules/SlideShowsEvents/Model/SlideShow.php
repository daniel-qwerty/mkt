...
class SlideShowsEvents_Model_SlideShow extends Com_Module_Model {

    /**
     *
     * @return SlideShowsEvents_Model_SlideShow 
     */
    ...
    public function doInsert(Com_Object $obj, $languages, $image) {
        ...
        $db = new Entities_SlideShowEvents();
    ...
    public function getList($lanId) {
        $text = new Entities_SlideShowEvents();
