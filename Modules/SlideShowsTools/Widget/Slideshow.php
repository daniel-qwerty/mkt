...
class SlideShowsTools_Widget_Slideshow extends Com_Object {
   ...
   /**
     ...
     * @static
     * @access public
     * @return SlideShowsTools_Widget_Slideshow 
     */
    ...
    public function render() {
        ...
        $list = SlideShowsTools_Model_SlideShow::getInstance()->getListEnable($this->lan->LanId);
