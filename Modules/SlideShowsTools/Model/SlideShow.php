...
class SlideShowsTools_Model_SlideShow extends Com_Module_Model {

    /**
     *
     * @return SlideShowsTools_Model_SlideShow 
     */
    ...
    public function doInsert(Com_Object $obj, $languages, $image) {
        ...
        $db = new Entities_SlideShowTools();
    ...
    public function getList($lanId) {
        $text = new Entities_SlideShowTools();
