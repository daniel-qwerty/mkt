...
class SlideShowsSuscription_Model_SlideShow extends Com_Module_Model {

    /**
     *
     * @return SlideShowsSuscription_Model_SlideShow 
     */
    ...
    public function doInsert(Com_Object $obj, $languages, $image) {
        ...
        $db = new Entities_SlideShowSuscription();
    ...
    public function getList($lanId) {
        $text = new Entities_SlideShowSuscription();
