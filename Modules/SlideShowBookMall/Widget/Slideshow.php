...
class SlideShowBookMall_Widget_Slideshow extends Com_Object
{
    ...
    public function render()
    {
        ...
        foreach ($list as $slide) {
            ...
            <div
                data-slide-bg="<?= Com_Helper_Url::getInstance()->getUploads(); ?>/Image/<?php echo $slide->SliImage; ?>"
                class="swiper-slide" data-swiper-slide-index="2"
                ...
                <div class="swiper-slide-caption">
                    <div class="jubotron-variant-1">
                        <div data-caption-animate="fadeInUp" class="post-meta not-animated">
                            <p>
                                <time datetime="2016"><a target="_blank" href="<?PHP echo $slide->SliLink; ?>"> april
                                        05, 2016</a></time>
                            </p>
                        </div>
                        <h1 data-caption-animate="fadeInUp" data-caption-delay="400" class="not-animated"><a
                                target="_blank"
                                href="<?PHP echo $slide->SliLink; ?>"><?PHP echo $slide->SliDescription; ?></a></h1><a
                            target="_blank" href="<?PHP echo $slide->SliLink; ?>" data-caption-animate="fadeInUp"
